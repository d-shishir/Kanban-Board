...
export function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="flex min-h-screen flex-col relative font-sans antialiased text-foreground bg-cover bg-center bg-no-repeat bg-fixed"
    ...
    >
      ...
      <Header />
      <main className="relative flex-1 overflow-hidden p-3 sm:p-5 lg:p-6">
